...
type Partner = {
  id: number;
  partner_name: string; // Changed from first_name/last_name
  partner_code: string; // Added missing field
...
type PartnerStore = {
  ...
  createPartner: (data: PartnerRequest) => Promise<void>; // Changed to PartnerRequest
