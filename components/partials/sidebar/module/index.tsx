...
const ModuleSidebar = ({ trans }: { trans: any }) => {
  ...
  const menusConfig = getMenu(profile as ApiUser);
  ...
  return (
    <>
      <div className="main-sidebar  pointer-events-none fixed start-0 top-0 z-[60] flex h-full xl:z-10 print:hidden">
        ...
        <div
          className={cn("border-default-200 pointer-events-auto relative z-10 flex flex-col h-full w-[228px] border-r  bg-card   transition-all duration-300", {
