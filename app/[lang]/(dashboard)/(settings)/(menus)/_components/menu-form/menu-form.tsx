  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="p-5 pl-20 pr-20">
        ...
        <Select
          value={currentStatusValue !== undefined ? currentStatusValue.toString() : undefined}
        ...
        >
          <SelectTrigger className="text-sm">
            {" "}
            {/* smaller trigger text */}
            <SelectValue className="text-sm" placeholder="Please select parent menu" />
          </SelectTrigger>
          <SelectContent className="text-sm">
            {" "}
            {/* smaller menu text */}
            {menuSelect.map(r => (
              <SelectItem key={r.value} value={r.value.toString()} className="text-sm">
                {r.label}
              </SelectItem>
            ))}
          </SelectContent>
