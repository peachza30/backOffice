...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, DialogContentProps>(({ className, children, size, overlayClass, overlayScroll = false, hiddenCloseIcon = false, ...props }, ref) => (
  <DialogPortal>
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => <div className={cn("flex flex-col-reverse sm:flex-row  gap-2 ", className)} {...props} />;
