...
export default function AddressSection({ HQ = [], BILLING = [], CONTACT = [], BRANCHES = [] }: { HQ?: AddressCard[]; BILLING?: AddressCard[]; CONTACT?: AddressCard[]; BRANCHES?: AddressCard[] }) {
  return (
    <>
      {HQ.map(card => (
      ...
      {CONTACT.map(card => (
        <Card key="contact" className="mb-4 border-2 border-blue-100/75">
          <CardHeader className="bg-blue-50/50">
