...
import useCheckAndRefreshToken from "@/hooks/useCheckAndRefreshToken";
const CorporateList = () => {
      ...
      <Card title="Corporate List">
        <CardHeader className="border-none pt-5 pl-6 pr-6">
          <div className="flex items-center justify-between w-full">
            <div className="text-xl font-semibold text-default-900 whitespace-nowrap">รายการคำขอนิติบุคคล ({loading ? "..." : metadata?.total})</div>
          </div>
        </CardHeader>
        <CardContent>
