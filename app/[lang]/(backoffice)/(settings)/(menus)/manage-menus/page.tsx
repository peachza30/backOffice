...
import MenuForm from "@/app/[lang]/(backoffice)/(settings)/(menus)/_components/menu-form/menu-form";
import MenuView from "@/app/[lang]/(backoffice)/(settings)/(menus)/_components/menu-view/menu-view";
